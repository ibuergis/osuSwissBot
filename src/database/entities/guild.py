...
class Guild(Base):
    ...
    osuScoresChannel: Mapped[str | None] = mapped_column(String[100], nullable=True, default=None)
    maniaScoresChannel: Mapped[str | None] = mapped_column(String[100], nullable=True, default=None)
    taikoScoresChannel: Mapped[str | None] = mapped_column(String[100], nullable=True, default=None)
    catchScoresChannel: Mapped[str | None] = mapped_column(String[100], nullable=True, default=None)
